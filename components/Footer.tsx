export default function Footer() {
  return (
    <footer className="bg-panel border-t border-white/10 py-12">
      <div className="container">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <h3 className="text-lg font-bold text-hackerGreen mb-4">Services</h3>
          ...
          <div>
            <h3 className="text-lg font-bold text-hackerGreen mb-4">Contact Info</h3>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4 text-xs">
            <a href="#" className="text-hackerBlue hover:underline">system_status: operational</a>
            <span className="opacity-50">|</span>
            <a href="#" className="text-hackerBlue hover:underline">uptime: 99.9%</a>
            <span className="opacity-50">|</span>
            <a href="#" className="text-hackerBlue hover:underline">last_update: 2024</a>
          </div>
        </div>
      </div>
    </footer>
